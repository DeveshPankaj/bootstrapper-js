...
(async () => {
  ...
  const result = await f.evaluate(async () => {
    try {
      await sdk().mkdir('/home/user1/.local/share/trainboard');
      await sdk().writeText('/home/user1/.local/share/trainboard/log.jsonl', '{"test":1}\n');
      return 'ok';
    } catch (e) { return 'ERR: ' + e.message; }
  });
  console.log('Direct write attempt result:', result);
